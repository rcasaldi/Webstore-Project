				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-body'>
									<img src='images/$pro_image' style='width:235px; height:250px;'/>
								</div>
...
if(isset($_POST["get_seleted_Category"]) || isset($_POST["selectBrand"]) || isset($_POST["search"])){
	if(isset($_POST["get_seleted_Category"])){
		...
		$sql = "SELECT * FROM products WHERE productLongDesc LIKE '%$keyword%'";
	}
		...
		if($count > 0){
			echo "
				<div class='alert alert-warning'>
						...
						<b>This product was already added to the cart. Continue Shopping!</b>
				</div>
			";//not in video
		} else {
			...
			if(mysqli_query($con,$sql)){
				echo "
					<div class='alert alert-success'>
						<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
						<b>Your product was added to the cart Successfully!</b>
					</div>
				";
			}
		}
...
if (isset($_POST["removeItemFromCart"])) {
	...
	if(mysqli_query($con,$sql)){
		echo "<div class='alert alert-danger'>
						<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
						<b>That product was removed from cart</b>
				</div>";
		exit();
	}
}
...
if (isset($_POST["updateCartItem"])) {
	...
	if(mysqli_query($con,$sql)){
		echo "<div class='alert alert-info'>
						<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
						<b>The product count was updated</b>
				</div>";
		exit();
	}
}
