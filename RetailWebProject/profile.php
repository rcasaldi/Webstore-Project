	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="collapse navbar-collapse" id="collapse">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="index.php"><span class="glyphicon glyphicon-modal-window"></span>Product</a></li>
					...
					<div class="dropdown-menu" style="width:400px;">
						<div id="cartdesign" class="panel panel-primary">
							<div class="panel-heading">
								<div class="row">
									<div class="col-md-3 col-xs-3">Cart Item Number</div>
									<div class="col-md-3 col-xs-3">Product Image</div>
									<div class="col-md-3 col-xs-3">Product Name</div>
									<div class="col-md-3 col-xs-3">Price Amount</div>
								</div>
							</div>
